...
class GroundLineStaticContractTests(unittest.TestCase):
    ...
    def test_release_docs_cover_ci_external_probes_and_clean_python_runs(self) -> None:
        ...
        self.assertIn("scripts/groundline_privacy_scan.py --json", readme)
        self.assertIn("scripts/groundline_provider_smoke.py --json", readme)
        self.assertIn("scripts/groundline_provider_smoke.py --json --stage-package --require-installed", readme)
        self.assertIn("scripts/groundline_provider_smoke.py --json --require-installed", readme)
        self.assertIn("scripts/groundline_release_gate.py --plan --json", checklist)
        self.assertIn('scripts/groundline_release_gate.py --plan --json --release-version "$RELEASE_VERSION"', checklist)
        self.assertIn('--release-version "$RELEASE_VERSION"', checklist)
        ...
        self.assertIn("scripts/groundline_privacy_scan.py --json", checklist)
        self.assertIn("scripts/groundline_provider_smoke.py --json --stage-package --require-installed", checklist)
        ...
        self.assertIn('--release-version "$RELEASE_VERSION"', korean_checklist)
        ...
        self.assertIn("groundline_provider_smoke.py --json --stage-package --require-installed", korean_checklist)
        self.assertIn("groundline_provider_smoke.py --json --require-installed", korean_checklist)
    ...
    def test_ci_workflow_runs_offline_validation_gates(self) -> None:
        ...
        self.assertIn("python3 scripts/groundline_privacy_scan.py --json", text)
    ...
    def test_install_and_update_docs_cover_public_repo_flow(self) -> None:
        ...
        self.assertIn("fake refreshed", install)
        self.assertIn("provider home", install)
        self.assertIn("fake_home_used=true", install)
        ...
        self.assertIn("python3 scripts/groundline_provider_smoke.py --json --stage-package --require-installed", smoke)
        self.assertIn("python3 scripts/groundline_provider_smoke.py --json --require-installed", smoke)
        self.assertIn("not_installed", smoke)
        self.assertIn("stage_package=true", smoke)
        self.assertIn("refuses to stage into", smoke)
        self.assertIn("next_actions=[]", smoke)
    ...
    def test_public_docs_cover_security_privacy_license_and_identity(self) -> None:
        ...
        self.assertIn("scripts/groundline_privacy_scan.py --json", public_release)
