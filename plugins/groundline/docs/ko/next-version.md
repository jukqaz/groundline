...
provider marketplace packaging은 완료됐고, v0.3.0 조각은 sanitized evidence,
offline safety check, provider별 partial을 숨기지 않는 release candidate입니다.
...
증거를 남기되, raw transcript나 provider home dump는 저장하지 않습니다.
...
Antigravity partial이 남으면 accepted defer로 기록하고, 다음 patch는 이 partial을
줄이는 데 집중합니다.
