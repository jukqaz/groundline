...
for GroundLine. It is not the Core guidance plugin and remains inactive until
the owner configures a schema-7 profile, a separate enrollment credential, and
hook trust.
